...
if __name__ == '__main__':
    ...
    filename1 = '../result/Text/Original/hyper_para_MAE.txt'
    r2_uni_1 = var_exp_Uni(traindata_x, traindata_y, filename1)
    r2_uni_2 = var_exp_Uni(testdata_x, testdata_y, filename1)
    print("Train r2_uni is :", r2_uni_1)
    print("Test r2_uni is :", r2_uni_2)

    filename2 = '../result/Text/Standard/hyper_para_MultiVariate_MAE.txt'
    r2_multi_1 = var_exp_multi(traindata_x, traindata_y, filename2)
    r2_multi_2 = var_exp_multi(testdata_x, testdata_y, filename2)
